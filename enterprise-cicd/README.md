...
- GitHub Actions ephemeral runner strategy (GitHub-hosted first, ARC on AKS when private-network/self-hosting is required)
- Language build images for Go / Python / Java / C++
- Azure Artifacts or Nexus/Artifactory dependency proxy
- AKS + Helm environments
